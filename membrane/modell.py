...
def berechne_osmotischen_druck(tds_ppm, temp_c):
    """
    Physikalische Berechnung des osmotischen Drucks (benötigt Masse/ppm).
    """
    i = 2.0 # Van't Hoff Faktor für NaCl/Leitungswasser-Mix
    r_gas = 0.08314 
...
def berechne_a_wert(q_test_lh, m_flaeche, p_test_bar, tds_test_ppm):
    ...
    # Rückgabe direkt in l/h pro m² pro bar
