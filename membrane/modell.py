...
def berechne_cp_faktor(q_p_lh, q_f_in_lh, q_c_lh, temp_c, m_flaeche_total_m2, m_flaeche_segment_m2):
    """
    Berechnet die Konzentrationspolarisation nach der Filmtheorie für eine einzelne Membranscheibe.
    """
    ...
    # Permeatflux J in m/s im aktuellen Segment
    j_m_s = (q_p_lh / m_flaeche_segment_m2) / 3600.0 / 1000.0
    
    # Querschnittsfläche automatisch aus der Gesamtfläche ableiten
    # Annahme: Standard-Elementlänge ca. 0.95m aktive Fläche, Spacerhöhe ca. 31 mil (0.8 mm)
